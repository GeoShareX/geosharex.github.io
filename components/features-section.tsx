...
const features = [
  {
    title: "Create Groups",
    description: "Organize your connections into groups for family, friends, or teams.",
    icon: (
  ...
  {
    title: "Share Pins",
    description: "Drop location pins on the map and share points of interest instantly.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description: "See location changes as they happen with live synchronization.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "Privacy First",
    description: "Control who sees your location with granular privacy settings.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
