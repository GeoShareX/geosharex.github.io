        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-gray max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">To use GeoShareX, you must:</p>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">You agree not to use GeoShareX to:</p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
